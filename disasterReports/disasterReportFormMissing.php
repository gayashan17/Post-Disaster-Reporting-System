        ...
        <main id="main"  class="login-wrapper d-flex justify-content-center align-items-center min-vh-100">
            ...
            <div class="reportFormPanel">
                ...
                <div class="reportFormPanel2 mx-auto">
                    ...
                    <div class="mb-4">Fill the below form to submit a Injured Person report.</div>
                    ...
                    <label class="text-muted fw-bold" for="ds-input">Divisional Secretariat</label>
                    <div class="input-group mb-4">
                        <select id="ds-input" name="ds-input" class="form-select text-muted" required disabled>
                            <option value="default">Select District First</option>
                        </select>
                    </div>
                    ...
                    <hr class="divider">
                        ...
                        <div class="input-group mb-4">
                            <input type="text" class="form-control border-start-1" name="name-input" placeholder="Enter Missing person's FullName">
                        </div>

                        <label class="text-muted fw-bold" for="age-input">Age</label>
                        <div class="input-group mb-4">
                            <input type="number" class="form-control border-start-1" name="age-input" placeholder="Enter Missing person's Age" oninput="if(this.value.length > 3) this.value = this.value.slice(0,3);">
                        </div>
                        ...
                        <label class="text-muted fw-bold" for="rel-input">Relationship </label>
                        <div class="input-group mb-4">
                        ...
                        <div class="input-group mb-4 w-100">
                            <input type="date" class="form-control text-muted" id="lastDate-input" name="lastDate-input">
                        </div>

                        <label class="text-muted fw-bold" for="lastTime-input">Last Seen Time </label>
                        <div class="input-group mb-4 w-100">
                            <input type="time" class="form-control text-muted" id="lastTime-input" name="lastTime-input">
                        </div>
