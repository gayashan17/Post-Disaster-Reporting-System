...
<nav id="sidebar" class="sidebar-admin">
    ...
    <a class="nav-item active admin-active" href="DSprofileForm.php">
...
<div class="panel">
    <div class="panel-header justify-content-center flex-column text-center py-4">
      ...
      <form action="DSprofile.php" method="POST" enctype="multipart/form-data" id="profilePicForm">
...
<script src="DSprofile.js"></script>
