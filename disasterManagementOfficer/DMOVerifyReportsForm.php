...
<head>
    ...
    <style>
        ...
        .ds-toolbar .form-control, .ds-toolbar .form-select{border-radius:10px}
...
<nav id="sidebar" class="sidebar-admin">
    ...
    <a class="nav-item" href="DMODashboardForm.php">
        <i class="bi bi-speedometer2"></i> Dashboard
    </a>

    <div class="nav-section-label">Report Management</div>
    <a class="nav-item active admin-active" href="DMOVerifyReportsForm.php">
...
<header id="topbar">
    ...
    <div class="topbar-title">Verify <span style="color:#2563eb">Reports</span></div>
    ...
    <div class="ds-card">
        ...
        <div class="ds-toolbar">
            <div class="input-group" style="max-width:320px">
                ...
                <input type="text" id="searchInput" class="form-control" placeholder="Search by Report ID, type...">
            </div>

            <select id="dsFilter" class="form-select" style="max-width:230px">
...
<script src="DMOVerifyReports.js"></script>
</body>
</html>
