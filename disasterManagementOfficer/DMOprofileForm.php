...
<nav id="sidebar" class="sidebar-admin">
    ...
    <a class="nav-item active admin-active" href="DMOprofileForm.php">
...
<div class="panel">
    <div class="panel-header justify-content-center flex-column text-center py-4">
      ...
      <form action="DMOprofile.php" method="POST" enctype="multipart/form-data" id="profilePicForm">
...
<script src="DMOprofile.js"></script>
