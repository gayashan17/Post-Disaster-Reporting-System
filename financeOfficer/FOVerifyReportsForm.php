...
<head>
    ...
    <title>Verify Reports - Financial Officer</title>
...
<nav id="sidebar" class="sidebar-admin">
    ...
    <a class="nav-item active admin-active" href="FOVerifyReportsForm.php">
...
<header id="topbar">
    ...
    <div class="topbar-title">Verify <span style="color:#10b981">Reports</span></div>
...
<main id="main" class="fo-page-wrap">
    <div class="fo-card">
        ...
        <div class="table-responsive">
            <table id="verifyReportsTable" class="table table-hover w-100">
                <thead>
                    <tr>
                        <th>Report ID</th>
                        <th>District</th>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content" style="border-radius:16px;border:none">
            <div class="modal-header" style="border-bottom:1px solid #eef0f2">
                <h5 class="modal-title fw-bold">DS Approved Report Details</h5>
            ...
            <div class="modal-footer" style="border-top:1px solid #eef0f2">
                ...
                <button type="button" class="btn btn-success" id="btnProcessReport">
                    <i class="bi bi-check2-circle"></i> Process Report
                </button>
            </div>
        </div>
    </div>
...
<script src="FOVerifyReports.js"></script>
</body>
</html>
