...
<head>
    ...
    <title>Financial Officer Dashboard</title>
...
<nav id="sidebar" class="sidebar-admin">
    ...
    <a class="nav-item active admin-active" href="FODashboardForm.php">
...
<header id="topbar">
    ...
    <div class="topbar-title">Financial Officer <span style="color:#10b981">Dashboard</span></div>
...
<main id="main" class="fo-page-wrap">
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-3 col-sm-6">
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-value" id="statDsApproved">0</div>
                    <div class="stat-label">DS Approved (Awaiting Verify)</div>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-value" id="statFoPending">0</div>
                    <div class="stat-label">My Processing Reports</div>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="stat-card">
                ...
                <div>
                    ...
                    <div class="stat-label">My Paid Reports</div>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-value" id="statTotalPaid">Rs. 0.00</div>
    ...
    <div class="row g-3">
        <!-- Chart -->
        <div class="col-md-7">
            <div class="fo-card h-100">
                <div class="card-title-sm">Payments (Last 6 Months)</div>
        ...
        <div class="col-md-5">
            <div class="fo-card h-100">
                <div class="card-title-sm">Recent Payments</div>
                <div class="table-responsive">
                    <table id="recentPaymentsTable" class="table table-hover w-100">
                        <thead>
                            <tr>
                                <th>Comp. ID</th>
                                <th>Report ID</th>
