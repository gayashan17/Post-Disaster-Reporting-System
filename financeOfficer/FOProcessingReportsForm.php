...
<head>
    ...
    <title>Processing Reports - Financial Officer</title>
    ...
    <style>
        ...
        .fo-toolbar .form-control, .fo-toolbar .form-select{border-radius:10px}
...
<nav id="sidebar" class="sidebar-admin">
    ...
    <a class="nav-item active admin-active" href="FOProcessingReportsForm.php">
        <i class="bi bi-hourglass-split"></i> Processing Reports
    </a>
    <a class="nav-item" href="FOPaymentHistoryForm.php">
...
<header id="topbar">
    ...
    <div class="topbar-title">Processing <span style="color:#10b981">Reports</span></div>
    ...
    <div class="fo-card">
        ...
        <div class="fo-toolbar">
            <div class="input-group" style="max-width:320px">
                ...
                <input type="text" id="searchInput" class="form-control" placeholder="Search by Report ID, DS office...">
            </div>

            <select id="districtFilter" class="form-select" style="max-width:230px">
                <option value="">All Districts</option>
            </select>
        </div>

        <div class="table-responsive">
            <table id="processingReportsTable" class="table table-hover w-100">
                <thead>
                    <tr>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content" style="border-radius:16px;border:none">
            ...
            <div class="modal-footer" style="border-top:1px solid #eef0f2">
                ...
                <button type="button" class="btn btn-success" id="btnGoToProcess">
            ...
            <div class="modal-body">
                <div class="pay-summary-box">
                    <div class="row">
                        <div class="col-md-4 item">
                            <div class="lbl">Compensation ID</div>
                            <div class="val" id="paySummaryCompID">-</div>
                        </div>
                        <div class="col-md-4 item">
                            <div class="lbl">Report ID</div>
                            <div class="val" id="paySummaryReportID">-</div>
                        </div>
                        <div class="col-md-4 item">
                            <div class="lbl">Approved Amount</div>
                            <div class="val" id="paySummaryApprovedAmount">-</div>
                        </div>
                    </div>
                </div>
                ...
                <form id="paymentForm">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="paidAmount" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Description</label>
                        <textarea class="form-control" id="paymentDescription" rows="3" placeholder="Payment notes / remarks..." required></textarea>
                    </div>
                    <div class="mb-2">
                        <label class="form-label fw-semibold">Receipt File (PDF / Image)</label>
...
<script src="FOProcessingReports.js"></script>
</body>
</html>
